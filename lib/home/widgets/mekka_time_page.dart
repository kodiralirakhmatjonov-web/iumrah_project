...
import 'package:iumrah_project/home/widgets/madinah_time_page.dart';
import 'package:iumrah_project/home/widgets/prayer_countdown_hero.dart';

class MekkaTimePage extends StatefulWidget {
  const MekkaTimePage({super.key});

  @override
  State<MekkaTimePage> createState() => _MekkaTimePageState();
}

class _MekkaTimePageState extends State<MekkaTimePage> {
  static const String _cityKey = 'makkah';
  static const String _cityName = 'Makkah';
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsetsDirectional.symmetric(horizontal: 24),
              child: _CitySwitch(
                isMakkahSelected: true,
                onMakkahTap: () {},
                onMadinahTap: () {
                  Navigator.of(context).pushReplacement(
                    PremiumRoute.push(const MadinahTimePage()),
                  );
                },
              ),
            ),
