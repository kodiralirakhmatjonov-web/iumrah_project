...
class _LoginPageState extends State<LoginPage> {
  // ================== PREMIUM DESIGN TOKENS (фиксируем по твоему шаблону) ==================
  ...
  static const double kHButton =
      65; // исключение для login/register по твоему требованию

  static const Color kBg = Color(0xFFE6E6EF);
  static const Color kSoftText = Color(0xFF1B1B1F); // чуть мягче чем pure black
  ...
  static const Color kError = Color(0xFFDB3B3B); // не кислотный
  ...
  final bool _submitted =
      false; // чтобы пароль/ошибка показывались после submit
  bool _authError = false; // ошибка логина (неверный пароль/аккаунт)
  ...
  void _onEmailChanged(String v) {
    ...
    setState(() {
      _emailTouched = true;
      _emailValid = ok;
      // если пользователь правит email — сбрасываем authError (чтобы не висел красный)
      _authError = false;
    });
  }
  ...
  void _onPassChanged(String v) {
    setState(() {
      // если пользователь правит пароль — сбрасываем authError (чтобы не висел красный)
      _authError = false;
    });
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // TITLES (как на макете слева)
              Text(
                '${LocalStrings.t('login_subtitle_1', lang)}\n'
                '${LocalStrings.t('login_subtitle_2', lang)}',
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: const [
                    BoxShadow(
                      blurRadius: 18,
                      offset: Offset(0, 10),
                      color: Color(0x14000000), // мягкая iOS-like
                    ),
                  ],
                ),
                child: Column(
                  children: [
                    _InputFieldPremium(
                      ...
                      hint: LocalStrings.t('login_email',
                          lang), // если ключа нет — замени на свой
                      controller: _email,
                      obscure: false,
                    ...
                    _InputFieldPremium(
                      ...
                      hint: LocalStrings.t('login_password', lang),
                      controller: _pass,
                      obscure: _obscure,
                    ...
                    _PremiumButton(
                      ...
                      enabled: _canSubmit,
                      loading: _loading,
                      text: LocalStrings.t('login_button', lang),
                      onTap: _login,
                    ),
                  ],
                ),
...
class _PremiumAuthSwitcherState extends State<_PremiumAuthSwitcher> {
  // right активен на Login
  double _dragT = 1.0; // 0..1 (0 = left, 1 = right)
  ...
  void _commitIfNeeded() {
    // Если пользователь утащил влево достаточно — уходим на register
    if (_dragT < 0.5) {
  ...
  @override
  Widget build(BuildContext context) {
    const height = 65.0; // по твоему токену switcher 65
    const radiusOuter = 50.0;
    const radiusInner = 50.0;
      ...
      builder: (context, c) {
        ...
        return GestureDetector(
          onHorizontalDragUpdate: (d) {
            ...
            setState(() {
              _dragT = (_dragT + deltaT).clamp(0.0, 1.0);
            });
          },
...
class _InputFieldPremium extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      height: height,
      decoration: BoxDecoration(
        color: _LoginPageState.kFieldFill,
        borderRadius: BorderRadius.circular(_LoginPageState.kRadiusField),
          ...
          Expanded(
            child: TextField(
              ...
              style: const TextStyle(
                fontFamily: 'Lato',
                fontSize: 16,
                color: _LoginPageState.kSoftText,
              ),
          ...
          children: [
            ...
            Expanded(
              child: GestureDetector(
                ...
                onTap: () {
                  // отдельно — открыть политику (как в твоем требовании)
                  onOpenPolicy();
                },
                child: Text(
                  text,
...
class _PremiumButtonState extends State<_PremiumButton> {
  ...
  Widget build(BuildContext context) {
    final bg =
        widget.enabled ? _LoginPageState.kBlack : _LoginPageState.kDisabled;
        ...
        child: AnimatedOpacity(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: bg,
              borderRadius:
                  BorderRadius.circular(_LoginPageState.kRadiusButton),
              boxShadow: const [
                BoxShadow(
                  blurRadius: 18,
                  offset: Offset(0, 10),
